      ...
      <aside id="default-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
        <div class="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-black">
          <ul class="space-y-2 font-medium">
            ...
            <li>
              <a href="#" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100  hover:text-primary dark:hover:bg-gray-800 group">
                ...
                <span class="flex-1 ms-3 whitespace-nowrap  text-start">Definitions</span>
              </a>
            </li>
          ...
          <div className="mt-12">
            ...
            <button  className='bg-[#63b0c9] text-white px-3 py-2 rounded-lg mt-4 font-semibold w-full' type='submit'>Log Out</button>
          </div>
        </div>
      </aside>
